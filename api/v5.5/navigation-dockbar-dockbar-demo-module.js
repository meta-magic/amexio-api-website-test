(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["navigation-dockbar-dockbar-demo-module"],{

/***/ "./src/app/navigation/dockbar/dockbar.demo.module.ts":
/*!***********************************************************!*\
  !*** ./src/app/navigation/dockbar/dockbar.demo.module.ts ***!
  \***********************************************************/
/*! exports provided: DockbarDemoModule */
...
/* harmony import */ var _dockbar_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dockbar.demo */ "./src/app/navigation/dockbar/dockbar.demo.ts");
 ...
 */
var DockbarDemoModule = /** @class */ (function () {
    function DockbarDemoModule() {
    }
    DockbarDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_dockbar_demo__WEBPACK_IMPORTED_MODULE_6__["DockbarDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _dockbar_demo__WEBPACK_IMPORTED_MODULE_6__["DockbarDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], DockbarDemoModule);
...
var DockbarDemo = /** @class */ (function () {
    ...
    DockbarDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/navigation/dockbar/navigation.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/navigation/dockbar/navigation.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=navigation-dockbar-dockbar-demo-module.js.map