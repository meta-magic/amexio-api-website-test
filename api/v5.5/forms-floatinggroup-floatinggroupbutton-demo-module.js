(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-floatinggroup-floatinggroupbutton-demo-module"],{

/***/ "./src/app/forms/floatinggroup/floatinggroupbutton.demo.module.ts":
/*!************************************************************************!*\
  !*** ./src/app/forms/floatinggroup/floatinggroupbutton.demo.module.ts ***!
  \************************************************************************/
/*! exports provided: FloatingGroupButtonDemoModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FloatingGroupButtonDemoModule", function() { return FloatingGroupButtonDemoModule; });
...
/* harmony import */ var _floatinggroupbutton_demo__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./floatinggroupbutton.demo */ "./src/app/forms/floatinggroup/floatinggroupbutton.demo.ts");
 ...
 */
var FloatingGroupButtonDemoModule = /** @class */ (function () {
    function FloatingGroupButtonDemoModule() {
    }
    FloatingGroupButtonDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_floatinggroupbutton_demo__WEBPACK_IMPORTED_MODULE_7__["FloatingGroupButtonDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _floatinggroupbutton_demo__WEBPACK_IMPORTED_MODULE_7__["FloatingGroupButtonDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], FloatingGroupButtonDemoModule);
    return FloatingGroupButtonDemoModule;
}());
...
/***/ "./src/app/forms/floatinggroup/floatinggroupbutton.demo.ts":
/*!*****************************************************************!*\
  !*** ./src/app/forms/floatinggroup/floatinggroupbutton.demo.ts ***!
  \*****************************************************************/
...
var FloatingGroupButtonDemo = /** @class */ (function () {
    function FloatingGroupButtonDemo(http) {
        this.http = http;
    ...
    FloatingGroupButtonDemo.prototype.getDta = function () {
        var _this = this;
        this.asyncFlag = true;
        setTimeout(function () {
    ...
    FloatingGroupButtonDemo.prototype.getHtmlAndTypeScriptCode = function () {
        var _this = this;
        var responseHtml;
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/forms/floatinggroupbutton/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/floatinggroupbutton/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
    ...
    FloatingGroupButtonDemo.prototype.onCopyClick = function () {
...
//# sourceMappingURL=forms-floatinggroup-floatinggroupbutton-demo-module.js.map