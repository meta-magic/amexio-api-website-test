(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["data-treedatagrid-treedatagrid-demo-module"],{
...
/*!***************************************************************!*\
  !*** ./src/app/data/treedatagrid/treedatagrid.demo.module.ts ***!
  \***************************************************************/
/*! exports provided: TreeDataGridDemoModule */
...
/* harmony import */ var _treedatagrid_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./treedatagrid.demo */ "./src/app/data/treedatagrid/treedatagrid.demo.ts");
 ...
 */
var TreeDataGridDemoModule = /** @class */ (function () {
    function TreeDataGridDemoModule() {
    }
    TreeDataGridDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_treedatagrid_demo__WEBPACK_IMPORTED_MODULE_6__["TreeDataGridDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _treedatagrid_demo__WEBPACK_IMPORTED_MODULE_6__["TreeDataGridDemo"], pathMatch: 'full'
                    }])],
...
var TreeDataGridDemo = /** @class */ (function () {
    ...
    TreeDataGridDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/data/treedatagrid/treedatagrid.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/data/treedatagrid/treedatagrid.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=data-treedatagrid-treedatagrid-demo-module.js.map