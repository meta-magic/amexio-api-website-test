(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-slider-slider-demo-module"],{
...
/* harmony import */ var _slider_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./slider.demo */ "./src/app/forms/slider/slider.demo.ts");
...
var SliderDemoModule = /** @class */ (function () {
    ...
    SliderDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_slider_demo__WEBPACK_IMPORTED_MODULE_6__["SliderDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _slider_demo__WEBPACK_IMPORTED_MODULE_6__["SliderDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], SliderDemoModule);
...
var SliderDemo = /** @class */ (function () {
    ...
    SliderDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/forms/slider/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/slider/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=forms-slider-slider-demo-module.js.map