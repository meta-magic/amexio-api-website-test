(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["panes-panel-panel-demo-module"],{
...
/*!**************************************************!*\
  !*** ./src/app/panes/panel/panel.demo.module.ts ***!
  \**************************************************/
/*! exports provided: PanelDemoModule, routedComponents */
...
/* harmony import */ var _panel_demo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./panel.demo */ "./src/app/panes/panel/panel.demo.ts");
...
var routes = [
    { path: '', component: _panel_demo__WEBPACK_IMPORTED_MODULE_2__["PanelDemoComponent"] },
];
var PanelDemoModule = /** @class */ (function () {
    ...
    PanelDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_panel_demo__WEBPACK_IMPORTED_MODULE_2__["PanelDemoComponent"]]
        })
    ], PanelDemoModule);
    return PanelDemoModule;
}());

var routedComponents = [_panel_demo__WEBPACK_IMPORTED_MODULE_2__["PanelDemoComponent"]];
...
var PanelDemoComponent = /** @class */ (function () {
    ...
    PanelDemoComponent.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/layout/panel/panel.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/layout/panel/panel.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=panes-panel-panel-demo-module.js.map