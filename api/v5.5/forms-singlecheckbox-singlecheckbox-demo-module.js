(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-singlecheckbox-singlecheckbox-demo-module"],{

/***/ "./src/app/forms/singlecheckbox/singlecheckbox.demo.module.ts":
/*!********************************************************************!*\
  !*** ./src/app/forms/singlecheckbox/singlecheckbox.demo.module.ts ***!
  \********************************************************************/
/*! exports provided: SinglecheckboxDemoModule */
...
/* harmony import */ var _singlecheckbox_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./singlecheckbox.demo */ "./src/app/forms/singlecheckbox/singlecheckbox.demo.ts");
 ...
 */
var SinglecheckboxDemoModule = /** @class */ (function () {
    function SinglecheckboxDemoModule() {
    }
    SinglecheckboxDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_singlecheckbox_demo__WEBPACK_IMPORTED_MODULE_6__["SinglecheckboxDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _singlecheckbox_demo__WEBPACK_IMPORTED_MODULE_6__["SinglecheckboxDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
...
var SinglecheckboxDemo = /** @class */ (function () {
    ...
    SinglecheckboxDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/forms/singlecheckbox/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/singlecheckbox/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=forms-singlecheckbox-singlecheckbox-demo-module.js.map