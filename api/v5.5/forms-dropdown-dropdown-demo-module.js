(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-dropdown-dropdown-demo-module"],{
...
/* harmony import */ var _dropdown_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dropdown.demo */ "./src/app/forms/dropdown/dropdown.demo.ts");
...
var DropDownDemoModule = /** @class */ (function () {
    ...
    DropDownDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_dropdown_demo__WEBPACK_IMPORTED_MODULE_6__["DropDownDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _dropdown_demo__WEBPACK_IMPORTED_MODULE_6__["DropDownDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], DropDownDemoModule);
...
var DropDownDemo = /** @class */ (function () {
    ...
    DropDownDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseData;
        //HTML FILE
        this.http.get('assets/data/code/forms/dropdown/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/dropdown/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=forms-dropdown-dropdown-demo-module.js.map