(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-creditcard-creditcard-demo-module"],{

/***/ "./src/app/forms/creditcard/creditcard.demo.module.ts":
/*!************************************************************!*\
  !*** ./src/app/forms/creditcard/creditcard.demo.module.ts ***!
  \************************************************************/
/*! exports provided: CreditCardDemoModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreditCardDemoModule", function() { return CreditCardDemoModule; });
...
/* harmony import */ var _creditcard_creditcard_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../creditcard/creditcard.demo */ "./src/app/forms/creditcard/creditcard.demo.ts");
...
var CreditCardDemoModule = /** @class */ (function () {
    function CreditCardDemoModule() {
    }
    CreditCardDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_creditcard_creditcard_demo__WEBPACK_IMPORTED_MODULE_6__["CreditCardDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _creditcard_creditcard_demo__WEBPACK_IMPORTED_MODULE_6__["CreditCardDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], CreditCardDemoModule);
    return CreditCardDemoModule;
}());
...
/***/ "./src/app/forms/creditcard/creditcard.demo.ts":
/*!*****************************************************!*\
  !*** ./src/app/forms/creditcard/creditcard.demo.ts ***!
  \*****************************************************/
...
var CreditCardDemo = /** @class */ (function () {
    function CreditCardDemo(http) {
        this.http = http;
        this.creditcard = new amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioCreditCardModel"]();
        this.getHtmlAndTypeScriptCode();
    }
    CreditCardDemo.prototype.getDta = function () {
        var _this = this;
        this.asyncFlag = true;
        setTimeout(function () {
    ...
    CreditCardDemo.prototype.getHtmlAndTypeScriptCode = function () {
        var _this = this;
        var responseHtml;
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/forms/creditcard/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/creditcard/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
    ...
    CreditCardDemo.prototype.refreshData = function () {
...
//# sourceMappingURL=forms-creditcard-creditcard-demo-module.js.map