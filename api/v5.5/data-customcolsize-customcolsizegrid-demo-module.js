(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["data-customcolsize-customcolsizegrid-demo-module"],{

/***/ "./src/app/data/customcolsize/customcolsizegrid.demo.module.ts":
/*!*********************************************************************!*\
  !*** ./src/app/data/customcolsize/customcolsizegrid.demo.module.ts ***!
  \*********************************************************************/
/*! exports provided: CustomColSizeDemoModule */
...
/* harmony import */ var _customcolsizegrid_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./customcolsizegrid.demo */ "./src/app/data/customcolsize/customcolsizegrid.demo.ts");
 ...
 */
var CustomColSizeDemoModule = /** @class */ (function () {
    function CustomColSizeDemoModule() {
    }
    CustomColSizeDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_customcolsizegrid_demo__WEBPACK_IMPORTED_MODULE_6__["CustomColSizeDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _customcolsizegrid_demo__WEBPACK_IMPORTED_MODULE_6__["CustomColSizeDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
...
var CustomColSizeDemo = /** @class */ (function () {
    ...
    CustomColSizeDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/data/customcolsize/customcolsize.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/data/customcolsize/customcolsize.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=data-customcolsize-customcolsizegrid-demo-module.js.map