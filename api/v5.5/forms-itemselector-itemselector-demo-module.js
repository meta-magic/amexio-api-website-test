(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-itemselector-itemselector-demo-module"],{

/***/ "./src/app/forms/itemselector/itemselector.demo.module.ts":
/*!****************************************************************!*\
  !*** ./src/app/forms/itemselector/itemselector.demo.module.ts ***!
  \****************************************************************/
/*! exports provided: ItemSelectorDemoModule */
...
/* harmony import */ var _itemselector_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./itemselector.demo */ "./src/app/forms/itemselector/itemselector.demo.ts");
 ...
 */
var ItemSelectorDemoModule = /** @class */ (function () {
    function ItemSelectorDemoModule() {
    }
    ItemSelectorDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_itemselector_demo__WEBPACK_IMPORTED_MODULE_6__["ItemSelectorDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _itemselector_demo__WEBPACK_IMPORTED_MODULE_6__["ItemSelectorDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
...
var ItemSelectorDemo = /** @class */ (function () {
    ...
    ItemSelectorDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseData;
        //HTML FILE
        this.http.get('assets/data/code/forms/itemselector/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/itemselector/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=forms-itemselector-itemselector-demo-module.js.map