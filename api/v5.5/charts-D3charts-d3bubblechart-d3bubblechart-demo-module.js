(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["charts-D3charts-d3bubblechart-d3bubblechart-demo-module"],{
...
var AmexioD3BubbleChartDemoComponent = /** @class */ (function () {
    function AmexioD3BubbleChartDemoComponent(http) {
        this.http = http;
    ...
    AmexioD3BubbleChartDemoComponent.prototype.getHtmlAndTypeScriptCode = function () {
        var _this = this;
        var responseHtml;
        var responseTs;
        var dataSource;
        //HTML FILE
        this.http.get('assets/data/code/charts/D3Charts/d3bubblechart/d3chart.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        // TS FILE
        this.http.get('assets/data/code/charts/D3Charts/d3bubblechart/d3chart.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
        ...
        // DataSource FILE
        this.http.get('assets/data/code/charts/D3Charts/d3bubblechart/datasource.json', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
        ...
        this.http.get('assets/data/code/charts/D3Charts/d3bubblechart/usersource.json', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
    ...
    AmexioD3BubbleChartDemoComponent.prototype.onCopyClick = function () {
...
/***/ "./src/app/charts/D3charts/d3bubblechart/d3bubblechart.demo.module.ts":
/*!****************************************************************************!*\
  !*** ./src/app/charts/D3charts/d3bubblechart/d3bubblechart.demo.module.ts ***!
  \****************************************************************************/
/*! exports provided: D3BubbleChartDemoModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "D3BubbleChartDemoModule", function() { return D3BubbleChartDemoModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _d3bubblechart_demo_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./d3bubblechart.demo.component */ "./src/app/charts/D3charts/d3bubblechart/d3bubblechart.demo.component.ts");
...
var D3BubbleChartDemoModule = /** @class */ (function () {
    function D3BubbleChartDemoModule() {
    }
    D3BubbleChartDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_d3bubblechart_demo_component__WEBPACK_IMPORTED_MODULE_7__["AmexioD3BubbleChartDemoComponent"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _d3bubblechart_demo_component__WEBPACK_IMPORTED_MODULE_7__["AmexioD3BubbleChartDemoComponent"], pathMatch: 'full'
                    }]), amexio_chart_d3__WEBPACK_IMPORTED_MODULE_8__["AmexioChartD3Module"]],
            providers: []
        })
    ], D3BubbleChartDemoModule);
    return D3BubbleChartDemoModule;
}());
...
//# sourceMappingURL=charts-D3charts-d3bubblechart-d3bubblechart-demo-module.js.map