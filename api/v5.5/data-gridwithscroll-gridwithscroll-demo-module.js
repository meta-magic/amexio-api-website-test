(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["data-gridwithscroll-gridwithscroll-demo-module"],{
...
/* harmony import */ var _gridwithscroll_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./gridwithscroll.demo */ "./src/app/data/gridwithscroll/gridwithscroll.demo.ts");
...
var GridWithScrollDemoModule = /** @class */ (function () {
    ...
    GridWithScrollDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_gridwithscroll_demo__WEBPACK_IMPORTED_MODULE_6__["GridWithScrollDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _gridwithscroll_demo__WEBPACK_IMPORTED_MODULE_6__["GridWithScrollDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
...
var GridWithScrollDemo = /** @class */ (function () {
    ...
    GridWithScrollDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/data/scrollgrid/scrollgrid.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/data/scrollgrid/scrollgrid.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=data-gridwithscroll-gridwithscroll-demo-module.js.map