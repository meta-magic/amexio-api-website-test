(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-rating-rating-demo-module"],{
...
/* harmony import */ var _rating_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./rating.demo */ "./src/app/forms/rating/rating.demo.ts");
...
var RatingDemoModule = /** @class */ (function () {
    ...
    RatingDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_rating_demo__WEBPACK_IMPORTED_MODULE_6__["RatingDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _rating_demo__WEBPACK_IMPORTED_MODULE_6__["RatingDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], RatingDemoModule);
...
var RatingDemo = /** @class */ (function () {
    ...
    RatingDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/forms/rating/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/rating/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=forms-rating-rating-demo-module.js.map