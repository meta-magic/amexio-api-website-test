(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["map-geochart-geochart-demo-module"],{
...
var GeoChartDemoComponent = /** @class */ (function () {
    ...
    GeoChartDemoComponent.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/map/geochart/chart.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/map/geochart/chart.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
        ...
        //DataSource FILE
        this.http.get('assets/data/code/map/geochart/datasource.json', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
/*!******************************************************!*\
  !*** ./src/app/map/geochart/geochart.demo.module.ts ***!
  \******************************************************/
/*! exports provided: GeoChartDemoModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GeoChartDemoModule", function() { return GeoChartDemoModule; });
/* harmony import */ var _geochart_demo_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./geochart.demo.component */ "./src/app/map/geochart/geochart.demo.component.ts");
...
var GeoChartDemoModule = /** @class */ (function () {
    function GeoChartDemoModule() {
    }
    GeoChartDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgModule"])({
            declarations: [_geochart_demo_component__WEBPACK_IMPORTED_MODULE_0__["GeoChartDemoComponent"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioMapModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _geochart_demo_component__WEBPACK_IMPORTED_MODULE_0__["GeoChartDemoComponent"], pathMatch: 'full'
                    }])]
        })
    ], GeoChartDemoModule);
...
//# sourceMappingURL=map-geochart-geochart-demo-module.js.map