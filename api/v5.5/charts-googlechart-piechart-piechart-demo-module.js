(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["charts-googlechart-piechart-piechart-demo-module"],{
...
var PieChartDemoComponent = /** @class */ (function () {
    ...
    PieChartDemoComponent.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/charts/piechart/chart.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/charts/piechart/chart.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
        ...
        //DataSource FILE
        this.http.get('assets/data/code/charts/piechart/datasource.json', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
/***/ "./src/app/charts/googlechart/piechart/piechart.demo.module.ts":
/*!*********************************************************************!*\
  !*** ./src/app/charts/googlechart/piechart/piechart.demo.module.ts ***!
  \*********************************************************************/
/*! exports provided: PieChartDemoModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _piechart_demo_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./piechart.demo.component */ "./src/app/charts/googlechart/piechart/piechart.demo.component.ts");
...
var PieChartDemoModule = /** @class */ (function () {
    function PieChartDemoModule() {
    }
    PieChartDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
            declarations: [_piechart_demo_component__WEBPACK_IMPORTED_MODULE_5__["PieChartDemoComponent"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_1__["AmexioWidgetModule"], _shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_1__["AmexioChartsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild([{
                        path: '', component: _piechart_demo_component__WEBPACK_IMPORTED_MODULE_5__["PieChartDemoComponent"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], PieChartDemoModule);
...
//# sourceMappingURL=charts-googlechart-piechart-piechart-demo-module.js.map