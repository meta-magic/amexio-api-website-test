(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-password-password-demo-module"],{
...
/* harmony import */ var _password_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./password.demo */ "./src/app/forms/password/password.demo.ts");
...
var PasswordDemoModule = /** @class */ (function () {
    ...
    PasswordDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_password_demo__WEBPACK_IMPORTED_MODULE_6__["PasswordDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _password_demo__WEBPACK_IMPORTED_MODULE_6__["PasswordDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], PasswordDemoModule);
...
var PasswordDemo = /** @class */ (function () {
    ...
    PasswordDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/forms/password/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/password/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=forms-password-password-demo-module.js.map