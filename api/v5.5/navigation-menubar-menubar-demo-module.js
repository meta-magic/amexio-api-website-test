(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["navigation-menubar-menubar-demo-module"],{
...
/* harmony import */ var _menubar_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./menubar.demo */ "./src/app/navigation/menubar/menubar.demo.ts");
...
var MenuBarDemoModule = /** @class */ (function () {
    ...
    MenuBarDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_menubar_demo__WEBPACK_IMPORTED_MODULE_6__["MenuBarDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _menubar_demo__WEBPACK_IMPORTED_MODULE_6__["MenuBarDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
    ], MenuBarDemoModule);
...
var MenuBarDemo = /** @class */ (function () {
    ...
    MenuBarDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseData;
        //HTML FILE
        this.http.get('assets/data/code/navigation/menubar/navigation.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/navigation/menubar/navigation.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
        ...
        //JSON FILE
        this.http.get('assets/data/componentdata/menubar.json', { responseType: 'text' }).subscribe(function (data) {
            responseData = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=navigation-menubar-menubar-demo-module.js.map