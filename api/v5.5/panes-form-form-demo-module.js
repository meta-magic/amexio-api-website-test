(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["panes-form-form-demo-module"],{

/***/ "./src/app/panes/form/employee.registration.ts":
/*!*****************************************************!*\
  !*** ./src/app/panes/form/employee.registration.ts ***!
  \*****************************************************/
...
/***/ "./src/app/panes/form/form.demo.html":
/*!*******************************************!*\
  !*** ./src/app/panes/form/form.demo.html ***!
  \*******************************************/
...
/* harmony import */ var _form_demo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./form.demo */ "./src/app/panes/form/form.demo.ts");
...
var routes = [
    { path: '', component: _form_demo__WEBPACK_IMPORTED_MODULE_2__["FormDemoComponent"] },
];
var FormDemoModule = /** @class */ (function () {
    function FormDemoModule() {
    }
    FormDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_form_demo__WEBPACK_IMPORTED_MODULE_2__["FormDemoComponent"]]
        })
    ], FormDemoModule);
    return FormDemoModule;
}());

var routedComponents = [_form_demo__WEBPACK_IMPORTED_MODULE_2__["FormDemoComponent"]];


/***/ }),

/***/ "./src/app/panes/form/form.demo.ts":
/*!*****************************************!*\
  !*** ./src/app/panes/form/form.demo.ts ***!
  \*****************************************/
...
/* harmony import */ var _employee_registration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./employee.registration */ "./src/app/panes/form/employee.registration.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FormDemoComponent = /** @class */ (function () {
    ...
    FormDemoComponent.prototype.getDta = function () {
        var _this = this;
        this.asyncFlag = true;
        setTimeout(function () {
    ...
    FormDemoComponent.prototype.getHtmlAndTypeScriptCode = function () {
        var _this = this;
        var responseHtml;
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/pane/form/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/pane/form/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
    ...
    FormDemoComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'form-demo',
            template: __webpack_require__(/*! ./form.demo.html */ "./src/app/panes/form/form.demo.html"),
        }),
...
//# sourceMappingURL=panes-form-form-demo-module.js.map