(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["forms-checkboxgroup-checkboxgroup-demo-module"],{

/***/ "./src/app/forms/checkboxgroup/checkboxgroup.demo.module.ts":
/*!******************************************************************!*\
  !*** ./src/app/forms/checkboxgroup/checkboxgroup.demo.module.ts ***!
  \******************************************************************/
/*! exports provided: CheckBoxGroupDemoModule */
...
/* harmony import */ var _checkboxgroup_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./checkboxgroup.demo */ "./src/app/forms/checkboxgroup/checkboxgroup.demo.ts");
 ...
 */
var CheckBoxGroupDemoModule = /** @class */ (function () {
    function CheckBoxGroupDemoModule() {
    }
    CheckBoxGroupDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_checkboxgroup_demo__WEBPACK_IMPORTED_MODULE_6__["CheckBoxGroupDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _checkboxgroup_demo__WEBPACK_IMPORTED_MODULE_6__["CheckBoxGroupDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
...
var CheckBoxGroupDemo = /** @class */ (function () {
    ...
    CheckBoxGroupDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseData;
        //HTML FILE
        this.http.get('assets/data/code/forms/checkboxgroup/form.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/forms/checkboxgroup/form.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/componentdata/checkgroup.json', { responseType: 'text' }).subscribe(function (data) {
            responseData = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=forms-checkboxgroup-checkboxgroup-demo-module.js.map