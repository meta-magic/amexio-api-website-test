(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["data-groupby-groupbygrid-demo-module"],{

/***/ "./src/app/data/groupby/groupbygrid.demo.module.ts":
/*!*********************************************************!*\
  !*** ./src/app/data/groupby/groupbygrid.demo.module.ts ***!
  \*********************************************************/
/*! exports provided: GroupByGridDemoModule */
...
/* harmony import */ var _groupbygrid_demo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./groupbygrid.demo */ "./src/app/data/groupby/groupbygrid.demo.ts");
 ...
 */
var GroupByGridDemoModule = /** @class */ (function () {
    function GroupByGridDemoModule() {
    }
    GroupByGridDemoModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_groupbygrid_demo__WEBPACK_IMPORTED_MODULE_6__["GroupByGridDemo"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_2__["AmexioWidgetModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([{
                        path: '', component: _groupbygrid_demo__WEBPACK_IMPORTED_MODULE_6__["GroupByGridDemo"], pathMatch: 'full'
                    }])],
            providers: []
        })
...
var GroupByGridDemo = /** @class */ (function () {
    ...
    GroupByGridDemo.prototype.getHtmlAndTypeScriptCode = function () {
        ...
        var responseTs;
        //HTML FILE
        this.http.get('assets/data/code/data/groupby/groupby.html', { responseType: 'text' }).subscribe(function (data) {
            responseHtml = data;
        }, function (error) {
        }, function () {
        ...
        //TS FILE
        this.http.get('assets/data/code/data/groupby/groupby.text', { responseType: 'text' }).subscribe(function (data) {
            responseTs = data;
        }, function (error) {
        }, function () {
...
//# sourceMappingURL=data-groupby-groupbygrid-demo-module.js.map